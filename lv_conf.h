...
#ifndef MUSIC_LVGL_USE_SDL
#define MUSIC_LVGL_USE_SDL 0
#endif

#ifndef MUSIC_LVGL_FS_POSIX_PATH
#define MUSIC_LVGL_FS_POSIX_PATH ""
#endif
...
#define LV_USE_FS_POSIX 1
    ...
    #define LV_FS_POSIX_PATH MUSIC_LVGL_FS_POSIX_PATH /**< Set the working directory. File/directory paths will be appended to it. */
...
#define LV_USE_TINY_TTF 0
    ...
    #define LV_TINY_TTF_CACHE_GLYPH_CNT 48
...
#define LV_USE_SDL              MUSIC_LVGL_USE_SDL
#if LV_USE_SDL
...
/** Driver for /dev/fb */
#define LV_USE_LINUX_FBDEV      (!MUSIC_LVGL_USE_SDL)
#if LV_USE_LINUX_FBDEV
    #define LV_LINUX_FBDEV_BSD           0
    #define LV_LINUX_FBDEV_RENDER_MODE   LV_DISPLAY_RENDER_MODE_PARTIAL
    #define LV_LINUX_FBDEV_BUFFER_COUNT  0
    #define LV_LINUX_FBDEV_BUFFER_SIZE   170
